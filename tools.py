...
from objectLib import building1, tree1, collisions,walkway1,cafe1,light
class buildingTool():
    def __init__(self,models,player,loader,accept):
        self.gameObjects = [building1(loader),tree1(loader),collisions(loader),walkway1(loader),cafe1(loader),light(loader)]
