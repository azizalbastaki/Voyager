...
class GUI():
    def __init__(self):
        ...
        self.frame = DirectFrame(parent=render2d, frameColor=(0, 0, 0.4, 1),
                                ...
                                pos=(-0.7, 0, 0.8))
        # self.frame = DirectFrame(parent=render2d, frameColor=(0.5, 0.1, 0.1, 1),
        #                         frameSize=(-0.27, 0.27, -0.17, 0.17),
        #                         pos=(-0.7, 0, 0.8))
        #self.topLeftHUD.setTransparency(True)
        self.jetpackStatus = OnscreenText(text='JETPACK FUEL: 100%', pos=(-0.75, 0.85),font=self.npfont,
